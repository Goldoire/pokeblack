...
int sub_021D370C(BattleScriptCtx *ctx, u32 *state, u32 *a2)
{
    u8 v1 = (u8)a2[1];
    u8 v2 = (u8)a2[2];
...
int sub_021D3734(BattleScriptCtx *ctx, u32 *state, u32 *a2)
{
    u8 v1 = (u8)a2[1];
    u8 v2 = (u8)a2[2];
    void *p = sub_021B9934(ctx->unk_04, (u8)a2[0]);
...
int sub_021D375C(BattleScriptCtx *ctx, u32 *state, u32 *a2)
{
    u8 v1 = (u8)a2[1];
    void *p = sub_021B9934(ctx->unk_04, (u8)a2[0]);
...
int sub_021D3794(BattleScriptCtx *ctx, u32 *state, u32 *a2)
{
    sub_021D5674(sub_021B9934(ctx->unk_04, (u8)a2[0]), (u8)a2[1], (u8)a2[2]);
    return 1;
}

int sub_021D37B8(BattleScriptCtx *ctx, u32 *state, u32 *a2)
{
    sub_021D56A0(sub_021B9934(ctx->unk_04, (u8)a2[0]), (u8)a2[1], (u8)a2[2]);
    return 1;
}

int sub_021D37DC(BattleScriptCtx *ctx, u32 *state, u32 *a2)
{
    sub_021D5DC0(sub_021B9934(ctx->unk_04, (u8)a2[0]), a2[1], (u8)a2[2]);
    return 1;
}

int sub_021D37FC(BattleScriptCtx *ctx, u32 *state, u32 *a2)
{
