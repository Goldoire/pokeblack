#ifndef POKEBLACK_OV135_H
#define POKEBLACK_OV135_H

/*
 * ===========================================================================
 *  ov135 -- Global Trade Station
 * ===========================================================================
 *
 * PROMOTED VERBATIM from src/ov135/worldtrade.h, which the ov135 worker
 ...
 *
 * ACTION FOR THE ov135 WORKER: replace
 *     #include "worldtrade.h"
 * with
 *     #include "ov135.h"
